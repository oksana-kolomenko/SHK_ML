...
#############
# potion-base-2M
feature_extractor_potion_base_2M = create_feature_extractor("potion-base-2M")

# potion-base-4M
feature_extractor_potion_base_4M = create_feature_extractor("potion-base-4M")

# potion-base-8M
feature_extractor_potion_base_8M = create_feature_extractor("potion-base-8M")

# bge-small-en-v1.5
feature_extractor_bge_small_en_v1_5 = create_feature_extractor("bge-small-en-v1.5")

# GIST-small-Embedding-v0
feature_extractor_gist_small_embedding_v0 = create_feature_extractor("GIST-small-Embedding-v0")

# MedEmbed-small-v0.1
feature_extractor_medembed_small_v0_1 = create_feature_extractor("MedEmbed-small-v0.1")

# bge-base-en-v1.5
feature_extractor_bge_base_en_v1_5 = create_feature_extractor("bge-base-en-v1.5")

# GIST-Embedding-v0
feature_extractor_gist_embedding_v0 = create_feature_extractor("GIST-Embedding-v0")

# MedEmbed-base-v0.1
feature_extractor_medembed_base_v0_1 = create_feature_extractor("MedEmbed-base-v0.1")

# bge-large-en-v1.5
feature_extractor_bge_large_en_v1_5 = create_feature_extractor("bge-large-en-v1.5")

# GIST-large-Embedding-v0
feature_extractor_gist_large_embedding_v0 = create_feature_extractor("GIST-large-Embedding-v0")
...
#############
# gte-small
feature_extractor_gte_small = create_feature_extractor("gte-small")

# gte-base
feature_extractor_gte_base = create_feature_extractor("gte-base")

# gte-base-en-v1.5
feature_extractor_gte_base_en_v1_5 = create_feature_extractor("gte-base-en-v1.5")

# gte-large
feature_extractor_gte_large = create_feature_extractor("gte-large")

# gte-large-en-v1.5
feature_extractor_gte_large_en_v1_5 = create_feature_extractor("gte-large-en-v1.5")
